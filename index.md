...
| [context/review.md](./context/review.md) | …you need to run an ad-hoc change-set review directly (no skill) — the cold-review engine: the review axes, scope vocabulary, change-set discovery, execution mode, model, and the reviewer spawn-prompt scaffold every review skill and `pre-push` share |
