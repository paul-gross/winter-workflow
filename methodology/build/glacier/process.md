...
Either way, **present the plan to the human caller and get approval before building.** Record the approved plan at `<documentation-root>/00-plan.md` — superseding any pre-gate draft written there above — so the session has a record. Do not advance until the human caller approves or adjusts it.
