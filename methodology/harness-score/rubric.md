...
- A dedicated directory or named cluster of agent-facing documentation (the convention varies — `context/`, `methodology/`, `docs/agents/`, `.cursor/rules/`, `AGENTS/`, `.github/copilot/`, etc.).
