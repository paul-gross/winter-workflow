...
probes a facet methodology permits. Spawn work only as the per-facet fan-out the faceted process declares — never any
other subagent.
...
Read `winter-workflow:/methodology/review/faceted/process.md` and execute its lead phase — gather, fan out per facet,
