...
|-------|-------------------|--------------------|
| [`cold-review`](../skills/cold-review/SKILL.md) | `cold-reviewer` | One-shot, single agent; the shared review engine injects its one-shot/no-team preamble, then the reviewer reads the diff and reports |
...
| [`harness-review`](../skills/harness-review/SKILL.md) | `harness-reviewer` | One-shot, single agent; the shared review engine injects its one-shot/no-team preamble, then the reviewer reads the diff plus harness/transcripts and reports |
