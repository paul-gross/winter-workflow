...
| `delegate` | Ad hoc work — unplanned, unphased instructions fed in conversationally, especially several in flight across different work targets — default to delegation via the standing foreman |
